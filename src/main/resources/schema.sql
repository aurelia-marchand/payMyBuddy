...
-- -----------------------------------------------------
-- Table `pay_my_buddy`.`bank_account`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS pay_my_buddy.bank_account (
  ...
  domiciliation 	VARCHAR(20) NULL 	DEFAULT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS pay_my_buddy.user_buddy (
  user_id 			BIGINT 		NOT NULL 	AUTO_INCREMENT,
  active			BIT(1) 		NOT NULL,
  address 			VARCHAR(100) NULL 		DEFAULT NULL,
  birthdate 		VARCHAR(12) NULL 		DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS pay_my_buddy.users_roles (
  ...
  INDEX FKe8x2wril5v1fm8ocy4morscy (user_id ASC) VISIBLE,
  CONSTRAINT FKe8x2wril5v1fm8ocy4morscy
    FOREIGN KEY (user_id)
    REFERENCES pay_my_buddy.user_buddy (user_id),
